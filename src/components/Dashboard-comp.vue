<template>
 <v-container fluid>
    <v-card color="#3853D8" height="150px" tile flat class="d-flex align-center justify-center" dark>
        <v-row>
            <v-col cols="12" sm="12">
                <h4 class="text-center">TENIS ESTILO MASCULINO</h4>
            </v-col>
            <v-col cols="12" sm="12">
    ...
    <v-card tile class="mx-16 mt-n10 card1" color="white">
                ...
                <v-card height="250px" tile flat color="#3890D8">
                    <v-row>
                        <v-col cols="12" sm="4" class="pl-8 pt-5">
                            ...
                            <h3 class="white--text mt-5">Conceito Trek Speed</h3>
                            <v-btn rounded color="#4C9CD8" dark class="withoutupercase px-8 mt-10">
                                Veja Mais...
                            </v-btn>
                        </v-col>
                        <v-col cols="12" sm="8">
                            <v-img src="bike.png" max-height="400" max-width="400" contain class="mt-n6"></v-img>
                        </v-col>
                    </v-row>
                </v-card>
            </v-col>
                ...
                <v-card height="250px" tile flat color="#6857E1">
                    <v-row>
                        <v-col cols="12" sm="6" class="pl-8 pt-5">
                            ...
                            <h6 class="white--text mt-8">Jaqueta</h6>
                            <h3 class="white--text mt-5">Mais Vendido do Ano</h3>
                            <v-btn rounded color="#8375E7" dark class="withoutupercase px-8 mt-10">
                                Veja Mais...
                            </v-btn>
                        </v-col>
                        <v-col cols="12" sm="6">
                            <v-img src="jacket2.png" max-height="280" max-width="420" contain class="mt-n2"></v-img>
                        </v-col>
                    </v-row>
                </v-card>
            </v-col>
        ...
        <v-row>
            ...
            <v-col cols="12" sm="3" class="mt-n6 px-0">
                <v-toolbar flat outlined>
                    <v-toolbar-title>
                        ESPORTIVOS POR: <span>Preço $-$$</span>
                    </v-toolbar-title>
                    <v-spacer></v-spacer>
            ...
            <v-col cols="3" class="py-0 pr-0 mt-n3">
                ...
                <v-card flat outlined tile>
                    ...
                    <v-toolbar flat>
                        <v-text-field placeholder="R$50,00" filled rounded dense class="mx-2"></v-text-field>
                        <v-text-field placeholder="R$1900,00" filled rounded dense class="mx-2"></v-text-field>
                    </v-toolbar>
                ...
                <v-card flat outlined tile>
                    <v-toolbar flat>
                        <v-icon color="grey" class="mr-2">mdi-chevron-down</v-icon>
                ...
                <v-card flat outlined tile>
                    ...
                    <v-chip-group column multiple>
                        <v-chip filter color="#E6E6E6" text-color="black" class="ml-2"></v-chip>
                        <v-chip filter color="#FFB500" text-color="white" class="ml-2"></v-chip>
                        <v-chip filter color="#F27229" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="#EB3427" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="#923FA3" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="#3A51DF" text-color="white" class="ml-2"></v-chip>
                        <v-chip filter color="#23A7F5" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="#5EB524" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="#7C5F4D" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="black" text-color="white" class="ml-2"> </v-chip>
                        <v-chip filter color="lime" text-color="white" class="ml-2"> </v-chip>
                    </v-chip-group>
                </v-card>
            ...
            <v-col cols="12" sm="3" class="mt-n3 px-0 pb-0">
                <v-toolbar flat oulined class="text-center">
    ...
    <v-card color="#EFF0F2" height="250px" tile flat dark class="d-flex align-center justify-center mt-n10 card2">
        <v-row>
            <v-col cols="12" sm="12">
                <h4 class="text-center black--text mt-10">ASSINE A NOSSA NEWSLETTER</h4>
            </v-col>

            <v-col cols="12" sm="12">
                <h6 class="text-center grey--text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum sed quod <br>
                    facilis qui explicabo. Odio soluta maiores enim cum quasi deleniti accusamus, ducimus.
                </h6>
            </v-col>

            <v-col cols="12" sm="12">
                <v-card flat color="transparent" class="d-flex justify-center">
                    <v-text-field placeholder="Coloque Seu E-mail" rounded class="shrink" background-color="grey" filled append-icon="mdi-email-outline" dense></v-text-field>
                </v-card>
            </v-col>
        </v-row>
    </v-card>
    ...
    export default {
        data: () => ({
            ...
            styles: [
                ...
                { title: "Corrida", count: "23" },
                { title: "Academia", count: "45" },
                { title: "Basquetebol", count: "11" },
                { title: "Futebol", count: "15" },
                { title: "Vôlei", count: "8" },
                { title: "Golf", count: "15" },
                { title: "Skate", count: "22" },
            ],
            brands: [
